...
const Header: React.FC = () => {
  return (
    <header className="bg-white border-b-4 border-[#1e3a8a] p-8 md:p-12 print:p-6">
      <div className="flex flex-col md:flex-row print:flex-row justify-between items-start md:items-end print:items-end gap-6">
        <div>
