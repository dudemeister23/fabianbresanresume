...
const Portfolio: React.FC = () => {
  return (
    <div className="bg-[#f4f6f8] border-l-4 border-[#1e3a8a] p-6 my-4 page-break-avoid">
      <h4 className="text-[#1e3a8a] text-sm font-bold tracking-widest uppercase mb-3">
        Selected Portfolio of Directed Programs
      </h4>

      <div className="space-y-4">
        <div>
          <h5 className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">Ophthalmology & Optometry</h5>
        ...
        <div>
          <h5 className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">Neurology & Psychiatry</h5>
          <ul className="space-y-1.5 text-sm">
            <li>
        ...
        <div>
          <h5 className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">Aesthetics & Dermatology</h5>
          <ul className="space-y-1.5 text-sm">
            <li>
